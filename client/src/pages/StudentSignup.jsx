    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-4 bg-slate-950 relative overflow-hidden">
            ...
            <div className="absolute inset-0 z-0">
                <img
                    src="https://images.unsplash.com/photo-1596276122653-651a3898309f?w=1920&q=80"
                    alt="Hostel Building"
            ...
            <div className="w-full max-w-md glass p-8 rounded-2xl shadow-xl border border-slate-800 relative z-10 animate-fade-in">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    <div className="form-group">
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full bg-slate-900/50 border border-slate-700 rounded-lg pl-10 pr-4 py-3 focus:ring-2 focus:ring-blue-500 outline-none transition-all text-slate-100 placeholder-slate-600"
                    ...
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 py-3 rounded-lg font-bold transition-all mt-6 shadow-lg shadow-blue-500/20 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 hover:scale-105 transform"
                    >
                        {isLoading ? <Loader2 className="animate-spin" size={20} /> : 'Create Student Account'}
                    </button>
